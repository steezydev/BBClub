...
const defaultMeta = {
  title: 'Based Beanz Club',
  siteName: 'Based Beanz Club',
  description:
  ...
  /** Without additional '/' on the end, e.g. https://github.com/steezy2401/NFTBoilerplate */
  url: 'https://basedbeanzclub.com',
  type: 'website',
  robots: 'follow, index',
